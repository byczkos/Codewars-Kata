...
//    URL: https://www.codewars.com/kata/complementary-dna/train/java

public class DnaStrand {

    public static String makeComplement(String dna) {
        return dna.replaceAll("A", "R").replaceAll("T", "A").replaceAll("R", "T").replaceAll("C", "Z").replaceAll("G", "C").replaceAll("Z", "G");
    }
}
