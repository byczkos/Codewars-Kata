...
//        URL: https://www.codewars.com/kata/double-cola/train/java

public class Line {

    public static void main(String[] args) {
        System.out.println(Line.WhoIsNext(new String[]{"Sheldon", "Leonard", "Penny", "Rakesh", "Howard"}, 1));
        System.out.println(Line.WhoIsNext(new String[]{"Sheldon", "Leonard", "Penny", "Rakesh", "Howard"}, 52));
//        System.out.println(Line.WhoIsNext(new String[]{"Sheldon", "Leonard", "Penny", "Rakesh", "Howard"}, 7230702951));
    }
