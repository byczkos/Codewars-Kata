...
//    since all (zero) adjacent pairs of integers satisfy the condition that the left integer does not
//    exceed the right integer in value. An empty list is considered a degenerate case and therefore
...
//    === check the solution ===
    public static void main(String[] args) {
        System.out.println(isAscOrder(new int[] {1,3,6,3,9}));
        System.out.println(isAscOrder(new int[] {1,3,6,8,9}));
        System.out.println(isAscOrder(new int[] {1,3,6,11,9}));
    }
