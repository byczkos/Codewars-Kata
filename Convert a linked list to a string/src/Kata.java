...
// you may want to read up on this article on Wikipedia. Specifically, the linked lists this Kata is referring to are singly
// linked lists, where the value of a specific node is stored in its data/$data/Data property, the reference to the next node
// is stored in its next/$next/Next/next_node property and the terminator for a list is null/NULL/None/nil.
//
//        Additionally, this Kata assumes that you have basic knowledge of Object-Oriented Programming (or a similar concept)
// in the programming language you are undertaking. If you have not come across Object-Oriented Programming in your selected
...
// followed by a whitespace character, an arow and another whitespace character (" -> "), followed by the rest of the list.
// The end of the string representation of a list must always end with null/NULL/None/nil/nullptr (all caps or all lowercase
// depending on the language you are undertaking this Kata in). For example, given the following list:
//
...
public class Kata {
    ...
    public static String stringify(Node list) {
        ...
        Node next = list;
        while(next != null) {
            stringBuilder.append(next.getData());
            stringBuilder.append(" -> ");
            next = next.getNext();
        }
        stringBuilder.append("null");
        String nazwa = stringBuilder.toString();
        return nazwa;
    }
}